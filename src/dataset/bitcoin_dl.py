...
class bitcoin_dataset():
    def __init__(self,args):
        ...
        args.bitcoin_args = utils.Namespace(args.bitcoin_args)
        ...
        timesteps = utils.aggregate_by_time(edges[:,self.ecols.TimeStep],args.bitcoin_args.aggr_time)
    ...
    def make_contigous_node_ids(self,edges):
        ...
        _, new_edges = new_edges.unique(return_inverse=True) # uni_elements: (num_nodes, ), index: (num_edges, 2)
